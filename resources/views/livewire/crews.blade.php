<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl flex justify-end">
        <div class="mr-2">
            <x-jet-button wire:click="confirmCrewAdd()" wire:loading.attr="disabled"
    ...
    <x-jet-dialog-modal wire:model="confirmingCrewAdd">
        <x-slot name="title">
            {{ __('Add Crew') }}
        </x-slot>
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$set('confirmingCrewAdd', false)" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
            </x-jet-secondary-button>

            <x-jet-button id="add-crew-button" class="ml-2 bg-green-500 hover:bg-green-700 active:bg-green-900"
                wire:click="addCrew()" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
